                      ...
                      children: [
                                ...
                                children: [
                                  GestureDetector(
                                    ...
                                    child: CircleAvatar(
                                      ...
                                      backgroundImage:
                                          selectedImage != null ? FileImage(selectedImage!) as ImageProvider : null,
                                      child:
                                          selectedImage == null
                                              ? Text(
                                ...
                                children: [
                                  Text(
                                    ...
                                    style: context.semiBold14(
                                      color: acc.isContactVisible ? ColorManager.disabledText : ColorManager.kPrimary,
                                    ),
                                  ),
                                  ...
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                      color: acc.isContactVisible ? ColorManager.disabledText : Colors.transparent,
                              ...
                              child: Row(
                                children: [
                                  Text(
                                    "Hide",
                                    style: context.semiBold14(
                                      color: acc.isSchoolVisible ? ColorManager.disabledText : ColorManager.kPrimary,
                                    ),
                                  ),
                                  SizedBox(width: context.horizontalSize(10)),
                                  Container(
                                    ...
                                    height: 18,
                                    decoration: BoxDecoration(
                                      color: acc.isSchoolVisible ? ColorManager.disabledText : Colors.transparent,
                                      borderRadius: BorderRadius.circular(20),
                                      border: Border.all(color: ColorManager.disabledText),
                                    ),
                                  ),
                        ...
                        Container(
                          ...
                          child: DropdownButton<String>(
                            ...
                            hint: Text("Select Province", style: context.regular14(color: ColorManager.disabledText)),
                            items:
                                ...
                                ((filterDetails.job == "Provincial School Teacher" ||
                                    ...
                                    .map(
                                      (value) => DropdownMenuItem(
                                        value: value,
                                        child: Text(value, style: context.regular14(color: ColorManager.disabledText)),
                                      ),
                                    )
                                    .toList(),
                            onChanged: (value) {
                          ...
                          onPress: () async {
                            if (informationFormKey.currentState!.validate() &&
                              ...
                              if (hasUnsavedChanges ||
                                ...
                                final shouldSave = await _saveAlertDialog(context, 'Confirm Changes', summary, 'Save');
