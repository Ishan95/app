...
class _EditDetailsScreenState extends State<EditDetailsScreen> {
  ...
  String _buildFilterSummary(FilterModel filter) {
    List<String> summary = [];
    if (accProvider.firstNameController.text.isNotEmpty ||
        accProvider.lastNameController.text.isNotEmpty) {
      summary.add(
        'Name: ${accProvider.firstNameController.text} ${accProvider.lastNameController.text}',
      );
    }
    ...
    summary.add(
      'Contact Visibility: ${accProvider.isContactVisible ? "Hidden" : "Visible"}',
    );
    summary.add(
      '${(filterDetails.job == "Provincial School Teacher" || filterDetails.job == "National School Teacher")? "School Visibility" : filterDetails.job == "Police Officer" ? "Police Station Visibility" : "Office Visibility"}: ${accProvider.isSchoolVisible ? "Hidden" : "Visible"}',
    );
          ...
          onTap: () {
            (hasUnsavedChanges ||
                    ...
                    accProvider.appUser?.phone !=
                        accProvider.contactController.text.trim() ||
                    accProvider.appUser?.note !=
                        accProvider.noteController.text.trim() ||
                    accProvider.appUser?.isPhoneHide !=
                        accProvider.isContactVisible ||
                    accProvider.appUser?.isSchoolHide !=
                        accProvider.isSchoolVisible)
                ? _confirmAlertDialog(
                  context,
                  ...
                  () {
                    List<String> parts =
                        (accProvider.appUser?.displayName ?? "").split(' ');
                    accProvider.firstNameController.text = parts[0];
                    accProvider.lastNameController.text =
                        parts.length > 1 ? parts[1] : '';
                    accProvider.contactController.text =
                        accProvider.appUser?.phone != null
                            ? accProvider.appUser!.phone.toString()
                            : '';
                    accProvider.isContactVisible =
                        accProvider.appUser?.isPhoneHide ?? false;
                    accProvider.isSchoolVisible =
                        accProvider.appUser?.isSchoolHide ?? false;
                    accProvider.noteController.text =
                        accProvider.appUser?.note ?? '';
                    ...
                    child: Column(
                      children: [
                        ...
                        Container(
                          ...
                          child: DropdownButton<String>(
                            value:
                                (filterDetails.job == "Provincial School Teacher" || filterDetails.job == "National School Teacher") ? filterDetails.scheme.isNotEmpty
                            ...
                            items:
                                ((filterDetails.job == "Provincial School Teacher" || filterDetails.job == "National School Teacher") ? filterDetails.schemeSubjects.keys : filterDetails.gradeList)
                                    .map(
                        ...
                        CenterTextIconButton(
                          onPress: () async {
                            ...
                            (accProvider.contactController.text.isNotEmpty || accProvider.contactController.text.length > 10 || accProvider.contactController.text.length < 12) &&
                              ...
                              ((filterDetails.job == "Provincial School Teacher" || filterDetails.job == "National School Teacher") ? (filterDetails.scheme != "PRIMARY"
                                    ? filterDetails.subject != ''
                                    : filterDetails.scheme != '') : filterDetails.grade != "") &&
                                filterDetails.choice1 != '') {
                              if (hasUnsavedChanges ||
                                ...
                                final summary = _buildFilterSummary(
                                  filterDetails,
                                );

                                if (summary == 'No changes selected.') {
                                  toastErrorMessage(
                                    "Please select at least one changes before saving.",
                                  );
                                  return;
                                }
                            ...
                            if (acc.contactController.text.isEmpty || acc.contactController.text.length < 10 || acc.contactController.text.length > 12) {
                              setState(() {
                                contactError = 'Incorrect contact number';
                              });
                            } else if ((filterDetails.job == "Provincial School Teacher" && filterDetails.school == '') || (filterDetails.job == "National School Teacher" && filterDetails.nationalSchool == '')) {
                              setState(() {
                            ...
                            if (filterDetails.scheme != "PRIMARY" &&
                                filterDetails.subject == '' && filterDetails.grade == "") {
                              setState(() {
