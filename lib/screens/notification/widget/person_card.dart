  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      decoration: BoxDecoration(
        border: Border.all(color: widget.personDetails.uid != currentUserId ? ColorManager.white : ColorManager.kTextGreen),
            ...
            isExpanded
                ? Row(
                  ...
                  children: [
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              ...
                              widget.personDetails.uid != currentUserId ? ImageFiltered(
                                ...
                                child: Text(
                                  widget.personDetails.job == "Provincial School Teacher" ? (widget.personDetails.school?.length ?? 0) > 28 ? '${widget.personDetails.school?.substring(0, 28)}...' : "${widget.personDetails.school ?? '*****************'}    " : widget.personDetails.job == "National School Teacher" ? (widget.personDetails.nationalSchool?.length ?? 0) > 28 ? '${widget.personDetails.nationalSchool?.substring(0, 28)}...' : "${widget.personDetails.nationalSchool ?? '*****************'}    " : widget.personDetails.job == "Nurse" ? (widget.personDetails.officeForNurse?.length ?? 0) > 28 ? '${widget.personDetails.officeForNurse?.substring(0, 28)}...' : "${widget.personDetails.officeForNurse ?? '*****************'}    " : widget.personDetails.job == "Management Assistant" ? (widget.personDetails.officeForMA?.length ?? 0) > 28 ? '${widget.personDetails.officeForMA?.substring(0, 28)}...' : "${widget.personDetails.officeForMA ?? '*****************'}    " : widget.personDetails.job == "Police Officer" ? (widget.personDetails.policeStations?.length ?? 0) > 28 ? '${widget.personDetails.policeStations?.substring(0, 28)}...' : "${widget.personDetails.policeStations ?? '*****************'}    " : (widget.personDetails.gramaNiladhariDivision?.length ?? 0) > 28 ? '${widget.personDetails.gramaNiladhariDivision?.substring(0, 28)}...' : "${widget.personDetails.gramaNiladhariDivision ?? '*****************'}    ",
                                  style: context.semiBold14(
                                    color: ColorManager.white,
                                  ),
                                  overflow: TextOverflow.visible,
                                  ...
                                  widget.personDetails.job == "Provincial School Teacher" ?(widget.personDetails.school?.length ?? 0) > 30 ? '${widget.personDetails.school?.substring(0, 30)}...' : "${widget.personDetails.school ?? '*****************'}    " : widget.personDetails.job == "National School Teacher" ? (widget.personDetails.nationalSchool?.length ?? 0) > 30 ? '${widget.personDetails.nationalSchool?.substring(0, 30)}...' : "${widget.personDetails.nationalSchool ?? '*****************'}    " : widget.personDetails.job == "Nurse" ? (widget.personDetails.officeForNurse?.length ?? 0) > 30 ? '${widget.personDetails.officeForNurse?.substring(0, 30)}...' : "${widget.personDetails.officeForNurse ?? '*****************'}    " : widget.personDetails.job == "Management Assistant" ? (widget.personDetails.officeForMA?.length ?? 0) > 30 ? '${widget.personDetails.officeForMA?.substring(0, 30)}...' : "${widget.personDetails.officeForMA ?? '*****************'}    " : widget.personDetails.job == "Police Officer" ? (widget.personDetails.policeStations?.length ?? 0) > 30 ? '${widget.personDetails.policeStations?.substring(0, 30)}...' : "${widget.personDetails.policeStations ?? '*****************'}    " : (widget.personDetails.gramaNiladhariDivision?.length ?? 0) > 30 ? '${widget.personDetails.gramaNiladhariDivision?.substring(0, 30)}...' : "${widget.personDetails.gramaNiladhariDivision ?? '*****************'}    ",
                                  style: context.semiBold14(
                                    color: ColorManager.white,
                                  ),
                                  overflow: TextOverflow.visible,
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              widget.personDetails.uid != currentUserId ? ImageFiltered(
                                imageFilter: ImageFilter.blur(
                                  sigmaX:
                                      widget.personDetails.isPhoneHide ? 5 : 0,
                                  sigmaY:
                                      widget.personDetails.isPhoneHide ? 5 : 0,
                                ),
                                child: Text(
                          ...
                          SizedBox(height: context.verticalSize(5)),
                          widget.personDetails.note != "" ? Text(
                    ...
                    (widget.personDetails.uid != currentUserId && widget.personDetails.uid != "")? GestureDetector(
                      onTap: () {
